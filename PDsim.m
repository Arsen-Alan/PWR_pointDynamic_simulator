...
delayedFeedback = 1; % 1 for ON 0 for OFF
source          = 0; % 1 for ON 0 for OFF
reactivity      = 3; % 0 OFF, 1 STEP, 2 TRIANG, 3 HARM
...
tspan  = [0 100]  ; % [s]      Time span in seconds
...
filename = 'data.xlsx';
writematrix("t [s]"       ,filename,'Sheet',name,'Range','B2');
writematrix("n [1/m3]"    ,filename,'Sheet',name,'Range','C2');
writematrix("rhoExt [$]"  ,filename,'Sheet',name,'Range','D2');
writematrix("rhoFuel [$]" ,filename,'Sheet',name,'Range','E2');
writematrix("rhoCool [$]" ,filename,'Sheet',name,'Range','F2');
writematrix("c1 [1/m3]"   ,filename,'Sheet',name,'Range','G2');
writematrix("c2 [1/m3]"   ,filename,'Sheet',name,'Range','H2');
writematrix("c3 [1/m3]"   ,filename,'Sheet',name,'Range','I2');
writematrix("c4 [1/m3]"   ,filename,'Sheet',name,'Range','J2');
writematrix("c5 [1/m3]"   ,filename,'Sheet',name,'Range','K2');
writematrix("c6 [1/m3]"   ,filename,'Sheet',name,'Range','L2');
writematrix("Tf [K]"      ,filename,'Sheet',name,'Range','M2');
writematrix("Tc [K]"      ,filename,'Sheet',name,'Range','N2');

writematrix(t                  ,filename,'Sheet',name,'Range','B3');
writematrix(n                  ,filename,'Sheet',name,'Range','C3');
writematrix(rhoExt/sum(yield)  ,filename,'Sheet',name,'Range','D3');
writematrix(feedRhoF/sum(yield),filename,'Sheet',name,'Range','E3');
writematrix(feedRhoC/sum(yield),filename,'Sheet',name,'Range','F3');
writematrix(C(:,1)             ,filename,'Sheet',name,'Range','G3');
writematrix(C(:,2)             ,filename,'Sheet',name,'Range','H3');
writematrix(C(:,3)             ,filename,'Sheet',name,'Range','I3');
writematrix(C(:,4)             ,filename,'Sheet',name,'Range','J3');
writematrix(C(:,5)             ,filename,'Sheet',name,'Range','K3');
writematrix(C(:,6)             ,filename,'Sheet',name,'Range','L3');
writematrix(Tf                 ,filename,'Sheet',name,'Range','M3');
writematrix(Tc                 ,filename,'Sheet',name,'Range','N3');
